...
local redzlib = {
    Themes = {
        Darker = {
            ["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(110, 0, 0)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(170, 15, 15)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(110, 0, 0))
			}),
			["Color Hub 2"] = Color3.fromRGB(130, 5, 5),
			["Color Stroke"] = Color3.fromRGB(190, 25, 25),
			["Color Theme"] = Color3.fromRGB(255, 0, 0),
			["Color Text"] = Color3.fromRGB(245, 230, 230),
		...
		Dark = {
			...
			["Color Hub 2"] = Color3.fromRGB(150, 10, 10),
			
			["Color Stroke"] = Color3.fromRGB(210, 35, 35),
			["Color Theme"] = Color3.fromRGB(255, 30, 30),
			["Color Text"] = Color3.fromRGB(255, 30, 30),
			["Color Dark Text"] = Color3.fromRGB(190, 130, 130)
		},
		Purple = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(140, 0, 0)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(220, 30, 30)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(140, 0, 0))
			}),
			["Color Hub 2"] = Color3.fromRGB(170, 10, 10),
			["Color Stroke"] = Color3.fromRGB(255, 50, 50),
			["Color Theme"] = Color3.fromRGB(255, 0, 0),
			["Color Text"] = Color3.fromRGB(255, 240, 240),
			["Color Dark Text"] = Color3.fromRGB(210, 140, 140),
			["Color Dark Purple"] = Color3.fromRGB(255, 0, 0),
			["Color Hub 9"] = Color3.fromRGB(0, 0, 0),
			["Color Dark Greem"] = Color3.fromRGB(0, 0, 0)
		},
    }, 
    ...
    Icons = (function()
        return {
            ...
            ["cameraoff"] = "rbxassetid://10709789686",
...
local SetProps, SetChildren, InsertTheme, Create do
    ...
    pcall(Save, "Nexus library V1.json")
end
...
function redzlib:SetTheme(NewTheme)
    ...
    SaveJson("Nexus library V1.json", redzlib.Save)
...
function redzlib:MakeWindow(Configs)
    ...
    local WMiniText = Configs[2] or Configs.SubTitle or "By: Max | Brookhaven Rp"
    ...
    local WindowBackground = Create("ImageLabel", MainFrame, {
        ...
        Image = "rbxassetid://108964313242546", 
        ImageTransparency = 0,
    ...
    ConnectSave(ControlSize1, function()
        if not Minimized then
            ...
            SaveJson("Nexus library V5.json", redzlib.Save)
        end
    end)
    ...
    function Window:CloseBtn()
        local Dialog = Window:Dialog({
            Title = "Embee Hub",  
            Text = "Você deseja fecha o Embee ? isso pode afeta sua experiencia ou prejudica seu jogo", 
            Options = {
                {"Fecha Fi", function()  
                    ScreenGui:Destroy()
                end},
    ...
    function Window:MakeTab(paste, Configs)
        ...
        function Tab:AddButton(Configs)
			local BName = Configs[1] or Configs.Name or Configs.Title or "fuck BRO Button Bug!!!"
...
TextBoxInput.Focused:Connect(function()
    CreateTween({Pencil, "ImageColor3", Color3.fromRGB(0, 0, 0), 0.2})
end)
...
Make("Stroke", ImageLabel) -- já vai pegar Color Stroke do tema se seu Make suportar
